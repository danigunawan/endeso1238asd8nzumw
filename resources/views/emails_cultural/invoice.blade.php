...
<p>Mohon untuk mengirim bukti transfer dengan melampirkan foto bukti transfer dengan cara mengklik link berikut ini <a href="{{ route('pembayaran_culture.culture', $id_pesanan) }}">Petunjuk Pembayaran</a> .</p>

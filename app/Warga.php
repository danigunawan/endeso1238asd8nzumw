...
class Warga extends Model
{
    ...
    protected $fillable = ['id_kategori_culture','nama_warga','jadwal_1','jadwal_2','jadwal_3','jadwal_4','jadwal_5','harga_endeso','harga_pemilik','latitude','longitude','alamat_warga','kapasitas','durasi','no_telp'];
